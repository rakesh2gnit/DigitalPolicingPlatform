...
public class OfflineActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tvTitle.setText(getResources().getString(R.string.offline));
        ...
        try {
            ...
            if (dirList != null && dirList.size() > 0) {
                ...
                for (int i = 0; i < dirList.size(); i++) {
                    count = Utilities.getInstance(this).getNumberOfFiles(directoryOffline + dirList.get(i) + "/");
            ...
            ExceptionLogger.Logger(e.getCause(), e.getMessage(), OfflineActivity.class, "onCreate");
        }
    }
    ...
    private OnItemClickListener.OnItemClickCallback onClickItem = new OnItemClickListener.OnItemClickCallback() {
        ...
        public void onItemClicked(View view, int position) {
            try {
                ...
                ExceptionLogger.Logger(e.getCause(), e.getMessage(), OfflineActivity.class, "onClickItem");
            }
        }
    };
}
