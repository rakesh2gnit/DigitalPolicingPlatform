...
import hcl.policing.digitalpolicingplatform.activities.process.flow.GetLocation;
...
public class PageSectionEdit {
     ...
     */
    public static void createPageSectionDetails(EditAnswerActivity act, List<PageSection_detailListBean> pageSection_detailListBeans, int attCount) {
        ...
        new Handler().postDelayed(() -> {
            ...
            try {
                if (act.specialLogic != null && act.specialLogic.equalsIgnoreCase(GenericConstant.SEARCH_OFFICER)) {
                    ...
                    act.populateUser(act.appSession.getUser());
                    ...
                    for (int i = attCount; i < pageSection_detailListBeans.size(); i++) {
                        ...
                        if (!pageSection_detailListBeans.get(i).getShowFieldsInOneGo()) {
                            ...
                            CreateField.editAttributes(act, pageSection_detailListBeans.get(i));
                            break;
...
//                    mapPageSection.put(sectionIndex, pageSection_detailListBeans);
                ...
                ExceptionLogger.Logger(e.getCause(), e.getMessage(), PageSectionEdit.class, "pageSectionDetails");
            }
        }, 500);
    }
}
