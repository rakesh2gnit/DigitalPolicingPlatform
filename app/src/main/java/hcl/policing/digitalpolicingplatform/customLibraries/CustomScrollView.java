...
public class CustomScrollView extends ScrollView {
    ...
    public void SetScrollView(@NonNull Context context, PropertiesBean scrollViewDTO) {
        try {
            ...
            ExceptionLogger.Logger(e.getCause(), e.getMessage(), CustomScrollView.class, "");
        }
    }

    public void setOrientation(Context context, CustomScrollView view, String orientation) {
        try {
            ...
            ExceptionLogger.Logger(e.getCause(), e.getMessage(), CustomScrollView.class, "setOrientation");
        }
    }
}
