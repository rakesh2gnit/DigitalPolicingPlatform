...
import hcl.policing.digitalpolicingplatform.constants.contolPannel.IconsDataService;
...
public class ClassicControlPannelFragment extends Fragment {

    Context context;
    private AppSession appSession;
    private RecyclerView rvIcons;
    private ArrayList<ProcessIconsDTO> listIcons;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.classic_controlpannel_fragment, container, false);
        context = getActivity();
        initToolbar();
        initView(view);
    ...
    private void initToolbar() {
        androidx.appcompat.app.ActionBar actionBar = ((ClassicControlPanelActivity) context).getSupportActionBar();
        ((ClassicControlPanelActivity) Objects.requireNonNull(getActivity())).createMenuButton(getResources().getString(R.string.control_pannel));
    ...
    private void setRecyclerview() {
        ...
        listIcons.addAll(IconsDataService.getControlIcon());
