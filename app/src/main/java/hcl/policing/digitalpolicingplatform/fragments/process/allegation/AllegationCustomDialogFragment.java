...
public class AllegationCustomDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static AllegationCustomDialogFragment newInstance(String searchEvent, String processName) {

        AllegationCustomDialogFragment frag = new AllegationCustomDialogFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        allegationSelectionListener = (AllegationSelectionListener) getActivity();
    ...
    private void initView(View view) {
        ...
        tvPersonHeader.setText(getString(R.string.choose_allegation));
    ...
    class ViewPagePersonAdaptor extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (aRightsMapperUpdated.get(position).getSectionName().contains(GenericConstant.POLE)) {
                callingFragment = new AllegationFragment();
                Bundle bundleDL = new Bundle();
                bundleDL.putSerializable(GenericConstant.SEARCH_KEYWORD, searchedWord);
                bundleDL.putSerializable(GenericConstant.LISTENER, allegationSelectionListener);
