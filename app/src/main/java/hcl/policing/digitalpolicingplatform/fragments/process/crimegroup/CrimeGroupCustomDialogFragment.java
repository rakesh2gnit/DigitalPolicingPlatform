...
public class CrimeGroupCustomDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static CrimeGroupCustomDialogFragment newInstance(String searchEvent, String processName) {

        CrimeGroupCustomDialogFragment frag = new CrimeGroupCustomDialogFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        crimeGroupSelectionListener = (CrimeGroupSelectionListener) getActivity();
    ...
    private void initView(View view) {
        ...
        tvPersonHeader.setText(getString(R.string.choose_crimegroup));
    ...
    class ViewPagePersonAdaptor extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (aRightsMapperUpdated.get(position).getSectionName().contains(GenericConstant.POLE)) {
                callingFragment = new CrimeGroupFragment();
                Bundle bundleDL = new Bundle();
                bundleDL.putSerializable(GenericConstant.SEARCH_KEYWORD, searchedWord);
                bundleDL.putSerializable(GenericConstant.LISTENER, crimeGroupSelectionListener);
