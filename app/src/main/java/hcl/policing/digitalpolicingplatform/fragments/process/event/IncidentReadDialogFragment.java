...
public class IncidentReadDialogFragment extends DialogFragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static IncidentReadDialogFragment newInstance(String searchPerson, String processName, boolean isPopulate) {

        IncidentReadDialogFragment frag = new IncidentReadDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                isListen = true;
                setFlag(true, false);
                readData("Do you want me to read incident data?");
            }
        }, 1500);
        return rootView;
    }
    ...
    private void readFragmentData(Fragment fragment) {
        ...
        if(fragment instanceof EventFragment) {
            ...
            EventFragment.readData();
            readData(EventFragment.textRead);
