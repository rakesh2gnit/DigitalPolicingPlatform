...
import hcl.policing.digitalpolicingplatform.adapters.process.fds.person.pole.PersonPoleListAdaptor;
...
public class PersonPoleFragment extends Fragment implements ItemClickListener {
    ...
    private void loadStopPersons() {
        ...
        new Thread(() -> {
            try {
                ...
                ExceptionLogger.Logger(e.getCause(), e.getMessage(), PersonPoleFragment.class, "loadStopPersons");
            }
        }).start();
    }
