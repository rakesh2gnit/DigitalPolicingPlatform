package hcl.policing.digitalpolicingplatform.fragments.process.fds.team;
...
import hcl.policing.digitalpolicingplatform.fragments.process.fds.team.pole.TeamPoleFragment;
...
public class TeamCustomDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static TeamCustomDialogFragment newInstance(String searchTeam, String processName) {

        TeamCustomDialogFragment frag = new TeamCustomDialogFragment();
        Bundle args = new Bundle();
        args.putString(GenericConstant.SEARCH_KEYWORD, searchTeam);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        teamSelectionListener = (TeamSelectionListener) getActivity();
    ...
    class ViewPagePersonAdaptor extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (aRightsMapperUpdated.get(position).getSectionName().contains(GenericConstant.POLE)) {
                callingFragment = new TeamPoleFragment();
                Bundle bundleDL = new Bundle();
                bundleDL.putSerializable(GenericConstant.SEARCH_KEYWORD, searchedWord);
                bundleDL.putSerializable(GenericConstant.LISTENER, teamSelectionListener);
