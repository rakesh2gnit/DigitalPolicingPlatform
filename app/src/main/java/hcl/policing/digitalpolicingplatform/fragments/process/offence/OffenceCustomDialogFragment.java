...
public class OffenceCustomDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static OffenceCustomDialogFragment newInstance(String searchEvent, String processName) {

        OffenceCustomDialogFragment frag = new OffenceCustomDialogFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        offenceSelectionListener = (OffenceSelectionListener) getActivity();
    ...
    private void initView(View view) {
        ...
        tvPersonHeader.setText(getString(R.string.choose_offence));
    ...
    class ViewPagePersonAdaptor extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (aRightsMapperUpdated.get(position).getSectionName().contains(GenericConstant.POLE)) {
                callingFragment = new OffenceFragment();
                Bundle bundleDL = new Bundle();
                bundleDL.putSerializable(GenericConstant.SEARCH_KEYWORD, searchedWord);
                bundleDL.putSerializable(GenericConstant.LISTENER, offenceSelectionListener);
