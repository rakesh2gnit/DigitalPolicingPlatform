...
public class OrganisationCustomDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public static OrganisationCustomDialogFragment newInstance(String searchEvent, String processName) {

        OrganisationCustomDialogFragment frag = new OrganisationCustomDialogFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        organisationSelectionListener = (OrganisationSelectionListener) getActivity();
    ...
    private void initView(View view) {
        ...
        tvPersonHeader.setText(getString(R.string.choose_org));
    ...
    class ViewPagePersonAdaptor extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (aRightsMapperUpdated.get(position).getSectionName().contains(GenericConstant.POLE)) {
                callingFragment = new OrganisationFragment();
                Bundle bundleDL = new Bundle();
                bundleDL.putSerializable(GenericConstant.SEARCH_KEYWORD, searchedWord);
                bundleDL.putSerializable(GenericConstant.LISTENER, organisationSelectionListener);
