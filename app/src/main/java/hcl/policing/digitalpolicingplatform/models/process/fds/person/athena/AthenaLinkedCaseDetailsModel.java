...
public class AthenaLinkedCaseDetailsModel {


    @Expose
    @SerializedName("CaseDetailResponse")
    private CasedetailresponseBean casedetailresponse;

    public CasedetailresponseBean getCasedetailresponse() {
        return casedetailresponse;
    }

    public void setCasedetailresponse(CasedetailresponseBean casedetailresponse) {
        this.casedetailresponse = casedetailresponse;
    }

    public static class CasedetailresponseBean {
        @Expose
