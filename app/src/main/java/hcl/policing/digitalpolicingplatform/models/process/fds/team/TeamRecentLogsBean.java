...
public class TeamRecentLogsBean implements Serializable {
    ...
    public TeamBean getObjectList() {
        return objectList;
    }

    public void setObjectList(TeamBean objectList) {
