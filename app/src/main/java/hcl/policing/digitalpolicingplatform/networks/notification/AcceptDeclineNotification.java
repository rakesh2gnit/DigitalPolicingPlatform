...
public class AcceptDeclineNotification {

    ResponseBody responseBody = null;

    public ResponseBody updateTask(final NotificationDetailActivity context, String taskId, final String officerId, final String status) {

        Log.e("called", "   callled>>>>");
        String masterDataVersionNo = "";//Preferences.getStringValue(this, Preferences.MASTERDATAVERSION_NO, "");

        NotificationRequestDTO notificationRequest = null;
        notificationRequest = GetNotificationRequest.getNotification(taskId, officerId, status);
        ...
        Call<ResponseBody> call1 = apiInterface.updateTaskAssign(notificationRequest);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    if (response.code() == 200) {
                        ...
                        context.acceptDeclineResult(status);
                    } else {
