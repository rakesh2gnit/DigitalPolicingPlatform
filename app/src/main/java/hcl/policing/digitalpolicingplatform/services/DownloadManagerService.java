...
public class DownloadManagerService extends IntentService {
    ...
    private void downloadImage(ResponseBody body) throws IOException {
        ...
        File outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "sample.jpg");
    ...
    private void sendProgressUpdate(boolean downloadComplete) {
        ...
        //LocalBroadcastManager.getInstance(DownloadManagerService.this).sendBroadcast(intent);
    }
