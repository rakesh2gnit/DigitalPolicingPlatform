...
public class OnDragTouchListener implements View.OnTouchListener {
    ...
    public OnDragTouchListener(LoginActivity act, View view, View parent) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (isDragging) {
            ...
            //loginActivity.onClickLoginAnimation();
            // RIGHT
            ...
            //loginActivity.onClickPinAnimation();
            // TOP
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    if(bounds[2] == maxRight) {
                        ...
                        mView.animate().x(maxRight-width).y(bounds[1]).setDuration(0).start();
                    }
                    break;
            }
            return true;
