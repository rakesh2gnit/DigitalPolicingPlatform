...
public class SwipeButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        background.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_blue_border));    addView(background, layoutParamsView);    final TextView centerText = new TextView(context);
        ...
        centerText.setTextColor(Color.WHITE);    background.addView(centerText, layoutParams);    final ImageView swipeButton = new ImageView(context);
        ...
        swipeButton.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_blue_round));
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        return true;
                    case MotionEvent.ACTION_UP:                              //Release logic here
                        if (active) {
                            collapseButton();
                        } else {
